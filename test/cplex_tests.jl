...
if @isdefined CPLEX
    ...
    @testset "Solving storage_test with CPLEX" begin
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: default outputs."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: optional outputs."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: restrictvars."
        NemoMod.calculatescenario(dbfile; jumpmodel = (reg_jumpmode ? Model(CPLEX.Optimizer) : direct_model(CPLEX.Optimizer())),
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: restrictvars and non time sliced fuels."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: storage net zero constraints."
        ...
        # Test with calcyears
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: calcyears."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: calcyears and non time sliced fuels."

        try
            SQLite.DBInterface.execute(db, "update FUEL set timesliced = 0 where val <> 'electricity'")

            NemoMod.calculatescenario(dbfile; jumpmodel = (reg_jumpmode ? Model(CPLEX.Optimizer) : direct_model(CPLEX.Optimizer())), varstosave = "vproductionbytechnology, vusebytechnology, vtotaldiscountedcost, vdemandannualnn, vdemandnn, vproductionbytechnology, vproductionnn, vrateofactivity, vrateofdemandnn, vrateofproduction, vrateofproductionbytechnologybymodenn, vrateofproductionbytechnologynn, vrateofproductionnn, vrateoftotalactivity, vrateofuse, vrateofusebytechnologybymodenn, vrateofusebytechnologynn, vrateofusenn, vtotalcapacityinreservemargin, vusebytechnology, vusenn", restrictvars=true, calcyears=[2020,2029], quiet = calculatescenario_quiet)
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_test.sqlite: minimum utilization."
    ...
    @testset "Solving storage_transmission_test with CPLEX" begin
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: non time sliced fuels."
        ...
        # Test MinimumUtilization
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: minimum utilization."
        ...
        # Test interest rates
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: interest rates."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: transshipment power flow."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: transmission line availability."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: minimum annual transmission between nodes."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: limited foresight optimization."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: limited foresight optimization with non time sliced fuels."
        ...
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on storage_transmission_test.sqlite: TransmissionAnnualMaxCapacityInvestment."
    ...
    @testset "Solving ramp_test with CPLEX" begin
        ...
        # Test with default outputs
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on ramp_test.sqlite: default outputs."
    ...
    @testset "Solving subsidy_test with CPLEX" begin
        testnumber = 0  # Counter used in @info messages
        ...
        # Test with default outputs
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on subsidy_test.sqlite: default outputs."
        ...
        # Test with subsidies
        testnumber += 1
        @info "Running CPLEX test $(testnumber) on subsidy_test.sqlite: subsidies."
        ...
        NemoMod.dropresulttables(db)
        testqry = SQLite.DBInterface.execute(db, "VACUUM")
    end  # "Solving subsidy_test with CPLEX"
