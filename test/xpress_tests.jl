...
function xpress_tests(compilation::Bool=false)
    ...
    if @isdefined Xpress
        ...
        @testset "Solving storage_transmission_test with Xpress" begin
            ...
            !compilation && @test isapprox(testqry[4,:val], 217.229192870532; atol=TOL)
            !compilation && @test isapprox(testqry[5,:val], 206.884936494903; atol=TOL)
            !compilation && @test isapprox(testqry[6,:val], 197.033275412995; atol=TOL)
            ...
            !compilation && @test isapprox(testqry[1,:val], 12672.8113766167; atol=TOL)
            !compilation && @test isapprox(testqry[2,:val], 2510.4457167612; atol=TOL)
            !compilation && @test isapprox(testqry[3,:val], 1611.02255514986; atol=TOL)
...
end  # xpress_tests(compilation::Bool=false)
