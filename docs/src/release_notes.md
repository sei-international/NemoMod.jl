...
## Version 2.4
  ...
  * **Maximum production share:** Added [`MaxShareProduction`](@ref MaxShareProduction), a parameter that specifies a technology's maximum share of production of a fuel in a given region and year (excluding production from storage).
